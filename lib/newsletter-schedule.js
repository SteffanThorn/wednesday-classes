 ...
 * Each week focuses on a specific area of the body, across three classes:
 *   Wed 9:15   — Functional Pain Relief
 *   Thu 17:30  — Structural Alignment
 *   Fri 18:00  — Sound Healing & Restorative Flow — gentle full-body
 *                stretching and breathwork, closed with Tibetan and Crystal
 *                Bowl sound healing. Unlike Wed/Thu, this one is intentionally
 *                the same every week rather than targeting that week's body
 *                focus area.
...
// Friday's Sound Healing session is the same every week (no body-part focus),
// so it's defined once here and spread into every week's classSummaries below.
const FRIDAY_SOUND_HEALING = {
  slot: 'Fri 18:00',
  series: 'Sound Healing & Restorative Flow',
  topic: 'Sound Healing & Restorative Flow',
  topicZh: '声音疗愈与身心修复',
  summary: 'Gentle full-body stretching and breathwork, closed with Tibetan and Crystal Bowl Sound Healing.',
  summaryZh: '温和的全身伸展与呼吸练习，以西藏颂钵与水晶钵声音疗愈作为收尾。',
};
const FRIDAY_BODY_FOCUS = 'Fri 18:00 Sound Healing & Restorative Flow';
const FRIDAY_BODY_FOCUS_ZH = '周五声音疗愈与身心修复';
const FRIDAY_DESCRIPTION_ZH = '周五晚上则是温和的全身伸展与呼吸练习，以西藏颂钵与水晶钵声音疗愈作为收尾。';
...
export const weeklySchedule = [
  {
    ...
    titleZh: '三课程周整合',
    bodyFocus: `Wed 9:15 Resistance Band & Neck Alignment · Thu 17:30 Breath & Nervous System Reset · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `周三弹力带与肩颈正位 · 周四呼吸与神经重塑 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '💆',
    description: `本周聚焦肩颈：周三用弹力带训练肩颈正位，改善长期低头工作、看手机导致的颈椎前移，以及肩部酸痛甚至偏头痛；周四通过呼吸练习释放肩颈紧张，促进神经系统重塑；${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Neck/Shoulder Relief · Posture Reset · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `肩颈释放 · 胸椎体态重置 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '💆',
    description: `本周核心是肩颈：晨课肩颈放松，周四胸腔打开矫正体态，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Hip Mobility · Hip Control · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `髋部灵活 · 髋稳定控制 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🌀',
    description: `围绕髋部：晨课髋部松解，周四建立髋关节控制力，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Knee Support · Knee Alignment · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `膝关节支持 · 膝对线优化 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🦵',
    description: `以膝关节为主：晨课膝关节养护，周四膝对线与稳定，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Core Support · Deep Core Stability · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `核心护腰 · 深层核心稳定 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🔥',
    description: `核心周：晨课激活核心护腰，周四建立深层核心稳定，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Breath Mobility · Rib Structure · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `呼吸活动度 · 肋骨结构优化 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🌬️',
    description: `呼吸容量提升周：晨课胸廓灵活，周四优化肋骨与呼吸力学，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Shoulder Mobility · Shoulder Stability · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `肩部灵活 · 肩部稳定强化 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🧘',
    description: `肩部整合周：晨课恢复肩活动度，周四强化肩稳定，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Foot Balance · Foot Mechanics · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `足部平衡 · 足部力学优化 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🦶',
    description: `足部周：晨课足部力量平衡，周四足部对线与平衡机制，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Fascia Release · Fascia Integration · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `筋膜释放 · 筋膜链整合 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '✨',
    description: `筋膜周：晨课全身筋膜释放，周四整合筋膜动力链，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Spine Decompression · Spinal Control · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `脊柱减压 · 脊柱控制稳定 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🧠',
    description: `脊柱周：晨课脊柱减压，周四强化脊柱控制与稳定，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Functional Movement · Functional Strength · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `功能动作 · 功能力量 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🏃',
    description: `功能整合周：晨课优化日常动作模式，周四转化为功能力量，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
  ...
  },
  {
    ...
    title: 'Three-Class Weekly Integration',
    titleZh: '三课程周整合',
    bodyFocus: `Full Body Integration · Full Body Flow · ${FRIDAY_BODY_FOCUS}`,
    bodyFocusZh: `全身整合 · 全身流动 · ${FRIDAY_BODY_FOCUS_ZH}`,
    emoji: '🌈',
    description: `收官整合周：将三类课程工具整合为可持续的每周自我照护方案，${FRIDAY_DESCRIPTION_ZH}`,
    classSummaries: [
      {
        slot: 'Wed 9:15',
        series: 'Functional Pain Relief',
