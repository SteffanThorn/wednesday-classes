...
const DAY_CLASS_NAME = {
  ...
  'thursday-afternoon': 'Beginner Yoga - Thursday 2PM',
...
export function inferDayFromClassName(className = '') {
  ...
  if (lower.includes('thursday') && lower.includes('2pm')) return 'thursday-afternoon';
  ...
  if (lower.includes('thursday')) return 'thursday-afternoon';
  return null;
}
