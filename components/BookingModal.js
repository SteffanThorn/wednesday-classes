        ...
        <div className="px-6 py-4 border-b border-glow-cyan/10">
          ...
          <div className="space-y-2">
            ...
            {displayedDates.map((date) => {
              ...
              // Parse date to get weekday and date separately
              const dateObj = new Date(date.date);
              const weekdayDate = dateObj.toLocaleDateString('en-NZ', { weekday: 'long', day: 'numeric', month: 'short' });
                ...
                >
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="text-center flex-1">
                      <div className="font-medium">{weekdayDate}</div>
