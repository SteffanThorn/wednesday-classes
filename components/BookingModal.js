...
const WEEKLY_FOCUS_SERIES = {
  ...
  'wednesday-evening': {
    '2026-04-01': {
      ...
      weekTitle: 'Week 1 — Breath Awareness & Relaxation',
      focus: 'Reconnect with natural breathing and reduce stress',
      bestFor: 'Beginners, stress, feeling overwhelmed',
    },
    '2026-04-08': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 2 — Diaphragmatic Breathing',
      focus: 'Activate deep breathing to calm the body',
      bestFor: 'Anxiety, shallow breathing, tight chest',
    },
    '2026-04-15': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 3 — Nervous System Down-Regulation',
      focus: 'Shift from “fight or flight” to relaxation',
      bestFor: 'Chronic stress, burnout',
    },
    '2026-04-22': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 4 — Body Scan & Deep Relaxation',
      focus: 'Release unconscious tension in the body',
      bestFor: 'Poor sleep, mental fatigue',
    },
    '2026-04-29': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 5 — Breath & Emotional Release',
      focus: 'Use breath to release stored emotions',
      bestFor: 'Emotional tension, feeling stuck',
    },
    '2026-05-06': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 6 — Rib Cage & Breath Expansion',
      focus: 'Improve breathing capacity and mobility',
      bestFor: 'Tight chest, limited breathing',
    },
    '2026-05-13': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 7 — Slow Flow for Nervous System',
      focus: 'Gentle movement to regulate the body',
      bestFor: 'Low energy, stiffness, stress',
    },
    '2026-05-20': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 8 — Restorative Yoga & Support',
      focus: 'Deep rest using props and support',
      bestFor: 'Fatigue, recovery, burnout',
    },
    '2026-05-27': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 9 — Breath & Mind Connection',
      focus: 'Calm the mind through breath awareness',
      bestFor: 'Overthinking, mental stress',
    },
    '2026-06-03': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 10 — Guided Meditation & Stillness',
      focus: 'Develop inner awareness and stillness',
      bestFor: 'Busy mind, difficulty switching off',
    },
    '2026-06-10': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 11 — Deep Nervous System Reset',
      focus: 'Full body and mind restoration',
      bestFor: 'Long-term stress, exhaustion',
    },
    '2026-06-17': {
      title: 'Nervous System Reset & Breathwork Series',
      subtitle: 'Calm the mind. Regulate stress. Reconnect with breath.',
      weekTitle: 'Week 12 — Integration & Letting Go',
      focus: 'Combine breath, body, and awareness',
      bestFor: 'Anyone wanting deep reset',
    },
  },
  'thursday-evening': {
    '2026-04-02': {
